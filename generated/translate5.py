...
for score in sorted(os.listdir(folder), key=lambda x: int(x)):
    ...
    if True:
        ...
        for number in numbers:
            ...
            file = os.path.join(program_folder, number+".txt")
            ...
            code.append("mov 0xc(%0), " + reg_mapping[4])
            code.append("mov 0x10(%0), " + reg_mapping[5])
            ...
            code.append("mov " + reg_mapping[4] + ", 0xc(%0)")
            code.append("mov " + reg_mapping[5] + ", 0x10(%0)")
            ...
            # for line in code:
            #     print("\t\""+line+"\t\\n\"")
            function_name = "sort5_"+score+"_"+criticalpath+"_"+number
